...
%      applied to the IMAGE before image_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to image_OpeningFcn via varargin.
%
%      *See IMAGE Options on GUIDE's Tools menu.  Choose "IMAGE allows only one
...
% Last Modified by GUIDE v2.5 19-Dec-2022 14:12:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'image_OpeningFcn', @image_OpeningFcn, ...
                   'image_OutputFcn',  @image_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% hObject    handle to g_img (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to bw_img (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
